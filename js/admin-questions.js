...
(function () {
  ...
  // Poster disimpan sebagai satu baris notes (subject = 'minda-santai'),
  // imej dalam bentuk data URL WebP. Baca awam dibuka melalui dasar SQL
  // notes_public_minda_santai (lihat supabase/minda-santai-public-read.sql).
